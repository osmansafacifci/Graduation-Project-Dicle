"""
MATR cell-level audit: provided cycle_life vs recomputed 80% × Q0 EOL.
...
EOL = first cycle index where QD <= 0.8 * Q0 for k=3 consecutive cycles
      (k_consecutive=3 follows the notebook's robust definition).

Usage:
    python 0_data_prep/build_matr_audit.py
"""
...
def main() -> int:
    ...
    if missing:
        ...
        for m in missing:
            print(f"        {m}")
        print("\nRun first:")
        print("    python 0_data_prep/download_data.py --only matr")
        return 1
