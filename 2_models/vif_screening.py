...
Algorithm:
  ...
  2. Standardize every active feature column (z-score on this MATR train slice).
...
Usage:
  python 2_models/vif_screening.py             # report only (default)
  python 2_models/vif_screening.py --drop      # iterative drop
  python 2_models/vif_screening.py --seed 42 --threshold 5.0 --n-cycles 100
"""
...
def main() -> int:
    ...
    if not split_path.exists():
        print(f"[error] {split_path} missing — run generate_splits.py first.")
        return 1
