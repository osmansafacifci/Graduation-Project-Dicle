...
Usage:
    ...
    python 2_modeling_featuring/shift_metrics.py --feature-sets 12 24 34
    python 2_modeling_featuring/shift_metrics.py --windows 100
"""
...
# Mirrors CAPACITY_RAW_FEATURES in build_sop12_features_v2.py; keep in sync.
